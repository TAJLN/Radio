...
public class PositionSongPlayer extends SongPlayer {
	...
	public PositionSongPlayer(Song song) {
		super(song);
		makeNewClone(moonplex.tajln.NoteBlockAPI.songplayer.PositionSongPlayer.class);
	}
	...
	public PositionSongPlayer(moonplex.tajln.NoteBlockAPI.songplayer.SongPlayer songPlayer) {
		super(songPlayer);
	}
